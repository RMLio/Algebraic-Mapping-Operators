...
public class RenameTest {
    ...
    class PairRenameTests {
        RenameOperator operator = new RenameOperator("RenameOp", Set.of("f_default"), Set.of("f_default"), Set.of(new Pair<>("?name", "fullname")));
    ...
    class AliasTests {
        ...
        public void aliasSolutionMappingTest() {
            RenameOperator operator = new RenameOperator("RenameOp", Set.of("f_default"), Set.of("f_default"), "aliased");
